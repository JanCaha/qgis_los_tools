...
class ExtractHorizonsAlgorithm(QgsProcessingAlgorithm):
    ...
    horizons_types = [NamesConstants.HORIZON_LOCAL, NamesConstants.HORIZON_GLOBAL, "all"]
    ...
    def postProcessAlgorithm(self, context, feedback):
        ...
        if self.horizon_type == self.horizons_types[2]:
            ...
            symbols.append(
                QgsRendererCategory(NamesConstants.HORIZON_GLOBAL, symbol_horizon_global,
                                    TextLabels.GLOBAL))
            ...
            symbols.append(
                QgsRendererCategory(NamesConstants.HORIZON_LOCAL, symbol_horizon_local,
                                    TextLabels.LOCAL))
    ...
    def save_global_horizon(self, sink: QgsFeatureSink, fields: QgsFields, los_feature: QgsFeature,
                            los: Union[LoSLocal, LoSGlobal, LoSWithoutTarget], los_type: str):
